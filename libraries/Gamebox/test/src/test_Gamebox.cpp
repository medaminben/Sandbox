...
class gamebox_test: public ::testing::Test {
    public:
...
TEST_F(gamebox_test, isOver_returns_false_spare) {
    roll_n_times(18,0);
    bowlingGame->roll(1);
    bowlingGame->roll(9);
...
TEST_F(gamebox_test, isOver_returns_true_nothing) {
    roll_n_times(18,0);
    bowlingGame->roll(1);
    bowlingGame->roll(2);
    EXPECT_TRUE(bowlingGame->isOver());
}
TEST_F(gamebox_test, isOver_returns_false_strike) {
    roll_n_times(18,0);
    bowlingGame->roll(10);
    bowlingGame->roll(10);
    EXPECT_FALSE(bowlingGame->isOver());
}
TEST_F(gamebox_test, isOver_returns_true_strike) {
    roll_n_times(18,0);
    bowlingGame->roll(10);
    bowlingGame->roll(10);
    bowlingGame->roll(10);
