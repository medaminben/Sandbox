...
// Point<T,n>
/**
* @brief  Point<T,n> basic_point template: 
+ container for any dimensional point
* 
* @param numeric_type a numeric type of the coordinates
* @param size dimensions 
*/
template<Numeric numeric_type, size_t size> 
struct basic_point {
    using type = numeric_type;
private:
    // attribute
...
private:
    ...
    template < Numeric point_type, 
               size_t  point_size >                   
    friend struct basic_point;
};
